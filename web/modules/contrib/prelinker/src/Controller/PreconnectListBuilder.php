...
/**
 * Provides a listing of preconnect domains
 */
class PreconnectListBuilder extends DraggableListBuilder
{
    /**
     * {@inheritdoc}
     */
    ...
    public function buildRow(EntityInterface $entity)
    {
        ...
        $row['domain']['#markup'] = $entity->get('domain');
